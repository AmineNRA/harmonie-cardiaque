...
function timer() {
    if (duration.value == 1) setTimeout(()=>{
        respire.classList.add("hidden");
        text.classList.add("hidden");
    }, 60000);
    else if (duration.value == 2) setTimeout(()=>{
        respire.classList.add("hidden");
        text.classList.add("hidden");
    }, 120000);
    else if (duration.value == 3) setTimeout(()=>{
        respire.classList.add("hidden");
        text.classList.add("hidden");
    }, 180000);
    else if (duration.value == 4) setTimeout(()=>{
        respire.classList.add("hidden");
        text.classList.add("hidden");
    }, 240000);
    else if (duration.value == 5) setTimeout(()=>{
        respire.classList.add("hidden");
        text.classList.add("hidden");
    }, 300000);
}
